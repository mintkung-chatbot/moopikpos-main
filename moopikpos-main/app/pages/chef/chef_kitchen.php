...
require __DIR__ . '/../chef/chef_layout.php';
...
<div class="container-fluid px-3 px-md-4">
    <div class="d-flex justify-content-between align-items-center mb-3">
        <div>
            <span class="badge bg-success"><i class="fa-solid fa-circle-check me-1"></i>เชื่อมต่อ</span>
            <span class="text-white-50 ms-2">รีเฟรชอัตโนมัติทุก 3 วินาที</span>
        </div>
        <div>
...
<script>
    ...
    function loadOrders() {
        $.get("' . auth_url('../../api/kitchen_api.php?action=fetch_orders') . '", function(data) {
            renderOrders(data);
        }, "json");
    }
    ...
    function updateStatus(id, currentStatus) {
        $.post("' . auth_url('../../api/kitchen_api.php?action=update_status') . '", { id: id, status: currentStatus }, function(res) {
            if(res.success) {
